...
func (m *MockOrderDBI) GetName(conStr string, userId int) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetName", conStr, userId)
	ret0, _ := ret[0].(string)
	return ret0
}

// GetName indicates an expected call of GetName.
func (mr *MockOrderDBIMockRecorder) GetName(conStr, userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetName", reflect.TypeOf((*MockOrderDBI)(nil).GetName), conStr, userId)
}
